			...
			<div class="col-md-9">
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 register-blocks">
						<h2>Register User :</h2>
						<form action="<%= request.getContextPath() %>/AddVendor" method="post"
							...
							<div class="form-group">
								<label for="address">Address : </label> <input type="text"
									class="form-control" id="type" name="address" required>
							</div>
							<div class="text-center">
								<button type="submit" class="btn btn-default">Register Vendor</button>
							</div>
						</form>
					</div>
				</div>
