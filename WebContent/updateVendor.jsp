			...
			<div class="col-md-9">
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 register-blocks">
						<h2>Update Vendor :</h2>
						<form action="<%= request.getContextPath() %>/UpdateVendor" method="post"
							...
							<div class="form-group">
								<label for="mobile">Mobile No</label> <input
									type="mobile_number" class="form-control" id="mobile" name="u_mobNo" maxlength="10" onkeypress='return validateQty(event);' required>
							</div>
							<div class="form-group">
