<%@page import="controller.SearchDAO"%>
<%@page import="view.UpdateTickets"%>
<%@page import="model.RegComplaint"%>
		  ...
		  <div class="col-md-9">
				<div class="box-for overflow">
					<div class="col-md-12 col-xs-12 register-blocks">
						<h2>Update User :</h2>
						<form action="<%= request.getContextPath() %>/UpdateTickets" method="post"
							class="was-validation" name="form1">
							<div class="form-group">
								<label for="name">Ticket No : </label> <input type="id"
									class="form-control" id="id1" name="ticketNo"  required>
							</div>
							
								<div class="form-group">
								<label for="name">Complaint Status</label> <input
									type="text" class="form-control" id="complaint" name="status" required>
							</div>	
